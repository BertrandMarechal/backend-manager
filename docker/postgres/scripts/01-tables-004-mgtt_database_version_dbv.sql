create table mgtt_database_version_dbv (
    ...
    dbv_database_to_use TEXT NULL,
    dbv_user_to_use TEXT NOT NULL DEFAULT 'root'::TEXT,
    dbv_dependencies json null,
    UNIQUE(fk_rep_dbv_repo_id, dbv_version_id, dbv_database_to_use)
);