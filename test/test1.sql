CREATE OR REPLACE FUNCTION mgtf_update_middle_tier_files(i_repo_name TEXT, i_parent_folder TEXT, i_serverless_file json, i_variables_file json default null)
RETURNS INTEGER
VOLATILE
AS $CODE$
BEGIN    
